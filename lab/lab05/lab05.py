...
def closer_city(lat, lon, city_a, city_b):
    ...
    distance_a = distance(city_target, city_a)
    distance_b = distance(city_target, city_b)
...
def sprout_leaves(t, leaves):
    ...
    # else:
    #   for branch in branches(t):
    #     return sprout_leaves(branch, leaves)
...
def preorder(t):
    ...
    """
    # result_list = []
    # def func(tree, results):
    #   if is_tree(tree):
    #     results.append(label(tree))
    #   else:
    #     results.append(label(tree))
    #     return tree(label(tree), [func(branch, results) for branch in branches(tree)])
    # func(t)
    # return results
    def helper(tr, ans):
        ans.append(label(tr))
